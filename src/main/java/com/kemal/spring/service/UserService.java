...
public class UserService {
    ...
    @Cacheable(value = "cache.byBankContaining")
    public Page<User> findByBankContaining(String bank, Pageable pageable) {
        return userRepository.findByBankContainingOrderByIdAsc(bank, pageable);
    }
...
//        user.setUser_status("0");
        ...
        user.setRoles(Collections.singletonList(roleService.findByName("ROLE_ADMIN")));
        return user;
    }
...
//    }
    ...
    public User getUpdatedUser(User persistedUser, UserUpdateDto userUpdateDto) {
        ...
        persistedUser.setBank(userUpdateDto.getBank());
